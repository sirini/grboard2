	<form id="boardCommentForm" method="post" action="<?php echo $boardLink; ?>/comment/<?php echo $boardPost['no']; ?>" class="form">
		...
		<ul class="list-group">
			...
			<li class="list-group-item"><input type="email" name="email" placeholder="이메일" class="form-control" /></li>
			<li class="list-group-item"><input type="url" name="homepage" placeholder="웹사이트" class="form-control" /></li>
			<?php endif; ?>

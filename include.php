...
$queArr = array(
	'list' => 'select no, signdate, subject, name, comment_count from ' . $db_prefix_board . 'bbs_{0} order by no {1} limit {2}'
);
...
function gr2list($id, $orderBy='desc', $limit=5, $cutstr=0) {
	...
	$colArr = array('no', 'signdate', 'subject', 'name', 'comment_count');
